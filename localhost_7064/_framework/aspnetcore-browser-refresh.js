setTimeout(async function () {
  ...
  const webSocketUrls = 'wss://localhost:44399/HomeCareWebsite/,ws://localhost:52722/HomeCareWebsite/'.split(',');
  const sharedSecret = await getSecret('');
  let connection;
